...
class SPACE_ID(Enum):
    ...
    MOBILE_TECH = auto()
    DOCTORS_ON_DECK = auto()        #not on hand off sheet
    DOCTOR_OFFICE = auto()
    DOCTOR_PRIVATE_RESTROOM = auto()
    OFFICE_MANAGER = auto()
    BUSINESS_OFFICE = auto()
    ALT_BUSINESS_OFFICE = auto()    #not on hand off
    STAFF_LOUNGE = auto()
    PATIENT_LOUNGE = auto()
    ...
    SHIP_REC = auto()
    CONFERENCE = auto()
    ASSOCIATE_OFFICE = auto()
    ASSOCIATE_RESTROOM = auto()
    MARKETING = auto()
    TEAM_LEADER = auto()
    PATIENT_CARE_CENTER = auto()
